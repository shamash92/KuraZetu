...
export function VoteSummary({ 
  ...
  const turnoutPercentage = registeredVoters > 0 ? ((totalVotesCast / registeredVoters) * 100).toFixed(1) : '0.0';
      ...
      <View style={styles.content}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statCard}>
            <Text style={styles.statValue}>{totalValidVotes.toLocaleString()}</Text>
            <Text style={styles.statLabel}>Valid Votes</Text>
          </View>
          
          <View style={styles.statCard}>
            <Text style={styles.statValue}>{rejectedVotes.toLocaleString()}</Text>
            <Text style={styles.statLabel}>Rejected Votes</Text>
          </View>
          
          <View style={styles.statCard}>
            <Text style={styles.statValue}>{disputedVotes.toLocaleString()}</Text>
            <Text style={styles.statLabel}>Disputed Votes</Text>
          </View>
          
          <View style={styles.statCard}>
            <Text style={styles.statValue}>{registeredVoters.toLocaleString()}</Text>
        ...
        <View style={styles.breakdown}>
          <View style={styles.breakdownRow}>
            ...
            <Text style={styles.breakdownValue}>{totalVotesCast.toLocaleString()}</Text>
          </View>
          ...
          <View style={styles.breakdownRow}>
            ...
            <Text style={styles.breakdownValue}>
              {totalVotesCast > 0 ? ((rejectedVotes / totalVotesCast) * 100).toFixed(2) : '0.00'}%
            </Text>
          </View>
        </View>
        ...
        <View style={styles.totalSection}>
          <View style={styles.totalRow}>
            ...
            <Text style={styles.totalValue}>{totalVotesCast.toLocaleString()}</Text>
          </View>
        </View>
      </View>
    </View>
