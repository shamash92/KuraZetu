...
const formSchema = z
  .object({
    ...
    last_name: z
      .string()
      .min(2, 'Last name is required, min 2 characters')
      .max(20),
    gender: z.enum(['M', 'F'], {
          ...
          <div className='flex flex-col items-center justify-start gap-6 text-center '>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-xs md:text-sm text-muted-foreground'>
                Join Community Tally to help ensure election transparency in
                Kenya
              </p>
            </div>
          </div>
          ...
          (error.includes('Polling center not found') ||
            ...
            >
              ...
              <p className='w-full text-sm text-white'>
                This could be as a result of copy pasting a link, start the
                registration and selecting the correct station
              </p>
            </Alert>
          ) : (
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className='text-xs text-gray-700 md:text-sm'>
                          Enter your Kenyan phone number starting with +254
                        </FormDescription>
                      ...
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent className='bg-red-200 '>
                            ...
                            <SelectItem value='party_agent'>Agent</SelectItem>
        ...
        <div className='container flex flex-col items-center justify-between gap-4 text-center'>
          <div className='flex items-center gap-2'>
            ...
            <p className='text-sm text-muted-foreground'>
              Community Tally - A citizen-led election transparency platform
            </p>
          </div>
        </div>
      </footer>
