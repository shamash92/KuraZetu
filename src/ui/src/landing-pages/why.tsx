...
function WhyComponent() {
    return (
        <section id="why" className="w-full py-4 md:py-6 bg-slate-50 dark:bg-slate-950">
                ...
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                Kura Zetu is designed to be a tool for civic empowerment
                                and transparency.
                            </p>
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                Understanding what Kura Zetu is not helps set proper
                                expectations.
                            </p>
                        </div>
                        <div className="space-y-2">
